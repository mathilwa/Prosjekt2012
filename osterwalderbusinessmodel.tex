...
\\
3. \emph{Acquire resources:} Usually it is not profitable for a company to have all resources and to have the knowledge to do all the activities. Cooperating with other firms by buying/lending resources is often more profitable than having everything in-house. 
...
Based on this business model framework, we will analyse the potential of Cyberlab's exergame. To gather information we have performed interviews with physiotherapists to find out if they are the right customer segment. We have used the nine building blocks as a basis for the questions asked in the interviews.
