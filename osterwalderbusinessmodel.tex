...
We have decided to use Osterwalder's Business Model Ontology for the analysis of the case. We analysed both Alexander Osterwalder's phd thesis \cite{osterwalderthesis} and his textbook "Business Model Generation" \cite{osterwalder} and our own synthesis of them. The thesis is a thoroughly description, while the book is easy to understand and on a more user friendly level. The foundation of our description lies in the textbook, with some details that we found important from the thesis. In this way we got an description that is suited well into our case analysis.\\ \\
...
\caption[Cost Structure]{Different cost structures}
\end{center}
\end{figure}
