...
Feedback from interviews shows that there is a demand for receiving the exergame as a part of a package, consisting of the software and the hardware needed. Hardware needed to play this exergame is the Kinect sensor, a windows computer and a screen. What physiotherapy clinics need and already have of technology varies. Some clinics might already possess a television, other might request a screen and a projector. Therefore, it is important for Cyberlab to offer the possibility to customize packages in accordance to their customers needs. Another feature to be included in the package is delivery, installation assistance and introduction help. A package containing this offer would have a higher price as it covers wages and expenses related to travel. From the interviews we have seen a demand for an offer like this, as all of the interviewees mentioned delivery, installation and introduction as important, so this could be a potential revenue stream for Cyberlab. \\ \\
...
The package price will cover hardware needed, and cost connected to development, investment and marketing of the product. T
